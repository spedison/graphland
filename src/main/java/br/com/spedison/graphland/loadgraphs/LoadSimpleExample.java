...
public class LoadSimpleExample implements LoaderGraphs<Void, Void> {
    ...
    @Override
    public Graph<Void, Void> load() {
        Graph<Void, Void> g = new Graph<>("Simple Graph of Example");
        var anuj = new Node<Void, Void>(Void.TYPE.cast(null), "anuj");
        var bob = new Node<Void, Void>(Void.TYPE.cast(null), "bob");
        var you = new Node<Void, Void>(Void.TYPE.cast(null), "you");
        var claire = new Node<Void, Void>(Void.TYPE.cast(null), "claire");
        var thom = new Node<Void, Void>(Void.TYPE.cast(null), "thom");
        var jonny = new Node<Void, Void>(Void.TYPE.cast(null), "jonny");
        var peggy = new Node<Void, Void>(Void.TYPE.cast(null), "peggy");
        var alice = new Node<Void, Void>(Void.TYPE.cast(null), "alice");
        var edi = new Node<Void, Void>(Void.TYPE.cast(null), "edi");
    ...
    @Override
    public void save(Graph<Void, Void> gh) {
        // Do not implemented. Itś a simple teste for load default graph.
